...
/**
 * Compiles and renders one {@link Bar} into an owned browser container.
 *
 ...
 * SVG plus a synchronous {@link RenderResult.dispose} cleanup function.
 *
 * @param bar - Validated bar to compile and render.
 * @param container - Connected browser element whose contents become renderer-owned.
 * @param options - Compilation, presentation, scale, repeat-label, and cancellation options.
 * @returns A promise of the frozen compilation and SVG result.
 * @throws {@link NotationCompilationError} when strict compilation fails.
 * @throws {@link NotationRenderError} when the target or options are invalid,
...
/**
 * Compiles and renders an ordered {@link Phrase} into an owned browser container.
 *
 * OpenSheetMusicDisplay is loaded only when this function is called. The target
 * must be connected to `document` and have a positive rendered width. A
 * successful render replaces its children and returns the generated five-line
 * SVG plus a synchronous {@link RenderResult.dispose} cleanup function.
 *
 * @param phrase - Validated phrase to compile and render.
 * @param container - Connected browser element whose contents become renderer-owned.
 * @param options - Compilation, presentation, scale, repeat-label, and cancellation options.
 * @returns A promise of the frozen compilation and SVG result.
 * @throws {@link NotationCompilationError} when strict compilation fails.
